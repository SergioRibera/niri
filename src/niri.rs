...
impl Niri {
    ...
    pub fn render_pointer<R: NiriRenderer>(
        ...
        let fractional_scale = output_scale_fractional.fractional_scale();
        ...
        match render_cursor {
            ...
            RenderCursor::Surface {
                ...
                let surface_top_left: Point<i32, Physical> =
                    (pointer_pos_logical - hotspot.to_f64()).to_physical_precise_round(output_scale);
